            ...
            <div className="container">
                <div className="row row-gap-4 align-items-center">
                    <div className="col-md-6 d-flex flex-column align-items-center" data-aos="fade-right" data-aos-delay="000">
                        ...
                        <h1 className="heading2 text-center" data-aos="fade-left" data-aos-delay="000">Boosts Inter-Cultural<br/><span>Respectability Amongst<br/>Employees</span></h1>
                    ...
                    <div className="col-md-6 d-flex flex-column align-items-center">
                        ...
                        <h1 className="heading2 text-center" data-aos="fade-right" data-aos-delay="000">Bolsters Creativity<br/>by <span>Reducing Food Monotony</span></h1>
            ...
            <div className="container">
                <div className="row row-gap-4 align-items-center">
                    <div className="col-md-6 d-flex flex-column align-items-center" data-aos="fade-left" data-aos-delay="000">
                        ...
                        <h1 className="heading2 text-center" data-aos="fade-right" data-aos-delay="000">Increases Post- <span>Lunch<br/>Productivity</span></h1>
                    ...
                    <div className="col-md-6 d-flex flex-column align-items-center">
                        ...
                        <h1 className="heading2 text-center" data-aos="fade-left" data-aos-delay="000">Encourages  <span>Interaction</span></h1>
            ...
            <div className="container">
                <div className="row row-gap-4 align-items-center">
                    <div className="col-md-6 d-flex flex-column align-items-center" data-aos="fade-left" data-aos-delay="000">
                        ...
                        <h1 className="heading2 text-center" data-aos="fade-left" data-aos-delay="000">Curtails Operating <span>Costs<br/>of Cafeterias</span></h1>
